...
plot_day_of_week_effect(hosp_pt_high, "COVIDhub-ensemble") # as.Date("2021-02-13"), mon
plot_day_of_week_effect(hosp_pt_high, "JHUAPL-Bucky") # as.Date("2021-02-27"), Mon
plot_day_of_week_effect(hosp_pt_high, "Google_Harvard-CPF") # forecasts made on Mon
plot_day_of_week_effect(hosp_pt_high, "Karlen-pypm") # forecasts made on Sunday - likely no weekday effects
plot_day_of_week_effect(hosp_pt_high, "JHUAPL-SLPHospEns") # forecasts made on Monday - likely no weekday effects
