...
plot_day_of_week_effect(hosp_pt_high, "LANL-GrowthRate") # as.Date("2021-05-22")
plot_day_of_week_effect(hosp_pt_high, "COVIDhub-ensemble") # as.Date("2021-02-13")
plot_day_of_week_effect(hosp_pt_high, "GT-DeepCOVID") 
plot_day_of_week_effect(hosp_pt_high, "JHUAPL-Bucky") # as.Date("2021-02-27")
plot_day_of_week_effect(hosp_pt_high, "Google_Harvard-CPF") 
plot_day_of_week_effect(hosp_pt_high, "Karlen-pypm") 
plot_day_of_week_effect(hosp_pt_high, "JHUAPL-SLPHospEns") 
...
plot_day_of_week_effect(hosp_pt_low, "LANL-GrowthRate") # as.Date("2021-05-22")
plot_day_of_week_effect(hosp_pt_low, "COVIDhub-ensemble") # as.Date("2021-02-13")
plot_day_of_week_effect(hosp_pt_low, "GT-DeepCOVID") 
plot_day_of_week_effect(hosp_pt_low, "JHUAPL-Bucky") # as.Date("2021-02-27")
plot_day_of_week_effect(hosp_pt_low, "Google_Harvard-CPF") 
plot_day_of_week_effect(hosp_pt_low, "Karlen-pypm") 
plot_day_of_week_effect(hosp_pt_low, "JHUAPL-SLPHospEns") 
