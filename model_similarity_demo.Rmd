...
# COVID-19 Forecasting Model Similarity Analysis for 1-4 Week Ahead Incident Death (top 5) 
...
# COVID-19 Forecasting Model Similarity Analysis for 1-4 Week Ahead Incident Case (top 5) 
...
# COVID-19 Forecasting Model Similarity Analysis for 1-4 Week Ahead Incident Death (bottom 5)  locations

The pairwise approximated Cramer's distances are calculated for the models that have complete submissions for all target, all 5 locations with the lowest number of COVID-19 deaths of at least 20,000 by the end of February 2021, all probability levels, from mid-October 2020 until May 24th, 2021 .

```{r}
source("./functions/distance_func_script.R")
# create sample data for this demo
# each target will have different sets of models based on the current filtering
wide_frame_death <- read.csv("./data/quantile_frame_bottom.csv") 
wide_frame_case <- read.csv("./data/quantile_frame_inc_bottom.csv") 
d_frame <- frame_format(wide_frame_death) 
c_frame <- frame_format(wide_frame_case) 
```
...
```{r,fig.align='center'}
grid.arrange(p_21, p_22,p_23, p_24, 
             ncol=2)
grid.arrange(p_151, p_152,p_153, p_154, 
             ncol=2)
grid.arrange(p_231, p_232,p_233, p_234, 
             ncol=2)
grid.arrange(p_501, p_502,p_503, p_504, 
             ncol=2)
grid.arrange(p_561, p_562,p_563, p_564, 
             ncol=2)
```
...
# COVID-19 Forecasting Model Similarity Analysis for 1-4 Week Ahead Incident Case (bottom 5)

The pairwise approximated Cramer's distances are calculated for the models that have complete submissions for all target, all probability levels, from mid-October 2020 until May 24th,2021 for 5 locations with the lowest incident cases in the week of February 27, 2021.
